...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Jibin George",
    description: `Cybersecurity Analyst/Threat Hunter/Penetration Tester.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Jibin George" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Jibin George" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">JG</span>
        </Link>
